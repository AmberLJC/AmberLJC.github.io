...
Liu, Jiachen (Amber)                  & 0000-0003-2317-1956                     & Founder \& CEO \\[6pt]
\multicolumn{3}{@{}l}{\textbf{*Organization and Location}} \\
\multicolumn{3}{@{}l}{ARA Commons, Inc.\quad|\quad 823 University Avenue, Palo Alto, CA 94301, USA}
\end{tabular}
...
\midrule
2026 & Present & Founder \& Chief Executive Officer & ARA Commons, Inc.\ (ARA Lab) & Palo Alto, CA, USA \\
\multicolumn{5}{@{}l}{\quad\small\itshape Executable, verifiable research infrastructure (ARA) for agentic scientific workflows. Backed by DCVC.} \\[3pt]
...
Liu, Jiachen (Amber)                  & 0000-0003-2317-1956                     & Founder \& CEO \\[6pt]
\multicolumn{3}{@{}l}{\textbf{*Organization and Location}} \\
\multicolumn{3}{@{}l}{ARA Commons, Inc.\quad|\quad Palo Alto, CA, USA}
\end{tabular}
...
\vspace{4pt}
I am Founder and Chief Executive Officer of ARA Commons, Inc.\ (the ARA Lab), which builds the infrastructure for executable, verifiable research artifacts (ARAs) and for the agentic scientific workflows that produce them. My role in the DISCOVER project is to contribute evaluation methodology, adversarial threat-surface expertise, and production validation infrastructure grounded in ARA Lab's operational deployment of multi-domain AI research agents.
...
As CEO of ARA Commons, I oversee the design and operation of multi-domain agentic research pipelines that span literature synthesis, hypothesis generation, experiment execution, and publication. These are precisely the workflows DISCOVER aims to harden against adversarial attack. My experience deploying AI agents in real academic and industry settings — including materials science collaborators at the University of Michigan — gives me direct insight into the threat surfaces and failure modes relevant to Focus Area A. I have not published under a different name.
